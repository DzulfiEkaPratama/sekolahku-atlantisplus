...
Route::get('/','Frontend\IndexController@index');
    ...
    ///// MENU \\\\\
        ...
        Route::delete('berita/{id}','DeleteController@delete');
        Route::delete('events/{id}','DeleteController@delete_events');
        Route::delete('imageslider/{id}','DeleteController@delete_image');
        Route::delete('kategoriberita/{id}','DeleteController@delete_kategori');
        Route::delete('programstudi/{id}','DeleteController@delete_jurusan');
        Route::delete('video/{id}','DeleteController@delete_video');

        /// Pengajar \\\
        Route::delete('delete_pengajar/{id}','DeleteController@delete_pengajar');
        /// EVENT \\\
