                        ...
                        <div class="col-7">
                            <div class="card">
                                <div class="card-header border-bottom">
                                    <h4 class="card-title">Kategori Berita <a
                                            href=" {{route('backend-berita.create')}} "
                                            ...
                                            <tr>
                                                ...
                                                <td class="p-1">
                                                    <a href=" {{route('backend-kategori-berita.edit', $kategoris->id)}} "
                                                        ...
                                                        <form action="{{ url('kategoriberita/'.$kategoris->id) }}" method="post" class="d-inline" onsubmit="return confirm('Yakin Hapus Data?')">
                                                                @method('delete')
                                                                @csrf
