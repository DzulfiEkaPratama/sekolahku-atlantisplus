                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select name="mengajar" class="form-control @error('mengajar') is-invalid @enderror">
                                            ...
                                            <option value="Wakil Hubungan Industri">Wakil Hubungan Industri</option>
                                            <option value="Wakil Pengendalian Mutu">Wakil Pengendalian Mutu</option>
                                            ...
                                            <option value="Fisika - Kimia">Fisika - Kimia</option>
